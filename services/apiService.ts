...
// FIX: Updated mock ads to use 'imageUrls' and added missing properties to match the 'Ad' type.
const getInitialMockAds = (): Ad[] => [
    // Synced Ads (Always Visible)
    // FIX: Added missing 'condition' property to satisfy the 'Ad' type.
    { id: 'ad-1', publicId: 'uuid-ad-1', title: 'Vintage Leather Jacket', description: 'A stylish vintage jacket.', price: 150, seller: MOCK_USERS[1], imageUrls: ['https://picsum.photos/seed/jacket/400/300'], location: 'Riyadh', rating: 4.5, reviews: 120, createdAt: new Date(Date.now() - 86400000 * 2).toISOString(), listingType: 'buy-now', syncStatus: 'synced', version: 1, boostScore: 10, condition: 'used' },
    // FIX: Added missing 'condition' property to satisfy the 'Ad' type.
    { id: 'ad-2', publicId: 'uuid-ad-2', title: 'Rare Comic Book (Sealed Auction)', description: 'First edition, mint condition.', price: 500, seller: MOCK_USERS[0], imageUrls: ['https://picsum.photos/seed/comic/400/300'], location: 'Jeddah', rating: 4.9, reviews: 34, createdAt: new Date(Date.now() - 86400000 * 3).toISOString(), listingType: 'auction', syncStatus: 'synced', auctionType: 'sealed', auctionDetails: { startTime: new Date().toISOString(), endTime: new Date(Date.now() + 86400000 * 2).toISOString(), startPrice: 500, bids: [] }, version: 1, boostScore: 25, condition: 'new' },
    
    // Public Ads (Visible when user is online)
    // FIX: Added missing 'condition' property to satisfy the 'Ad' type.
    { id: 'ad-3', publicId: 'uuid-ad-3', title: 'Acoustic Guitar', description: 'Great for beginners.', price: 120, seller: MOCK_USERS[1], imageUrls: ['https://picsum.photos/seed/guitar/400/300'], location: 'Dammam', rating: 4.2, reviews: 5, createdAt: new Date(Date.now() - 86400000 * 1).toISOString(), listingType: 'buy-now', syncStatus: 'public', version: 1, boostScore: 5, condition: 'used' },
    // FIX: Added missing 'condition' property to satisfy the 'Ad' type.
    { id: 'ad-4', publicId: 'uuid-ad-4', title: 'Retro Console (Dutch Auction)', description: 'Classic games included. Price drops every hour!', price: 300, seller: MOCK_USERS[0], imageUrls: ['https://picsum.photos/seed/console/400/300'], location: 'Riyadh', rating: 4.8, reviews: 78, createdAt: new Date(Date.now() - 86400000 * 4).toISOString(), listingType: 'auction', syncStatus: 'public', auctionType: 'dutch', auctionDetails: { startTime: new Date().toISOString(), endTime: new Date(Date.now() + 86400000).toISOString(), startPrice: 350, currentPrice: 300, bids: [] }, version: 1, boostScore: 0, condition: 'refurbished' },
    
    // Local Ad (Only visible to owner)
    // FIX: Added missing 'condition' property to satisfy the 'Ad' type.
    { id: 'ad-5', publicId: 'uuid-ad-5', title: 'Handmade Ceramic Mug (English Auction)', description: 'Perfect for your morning coffee.', price: 25, seller: MOCK_USERS[1], imageUrls: ['https://picsum.photos/seed/mug/400/300'], location: 'Jeddah', rating: 5.0, reviews: 1, createdAt: new Date().toISOString(), listingType: 'auction', syncStatus: 'local', auctionType: 'english', auctionDetails: { startTime: new Date().toISOString(), endTime: new Date(Date.now() + 86400000 * 3).toISOString(), startPrice: 25, bids: [{userId: 'user-1', username: 'mazdady_admin', amount: 28, timestamp: new Date().toISOString(), signature: 'mock_sig'}] }, version: 1, boostScore: 0, condition: 'new' },
];
...
export const createAd = async (data: CreateAdData): Promise<Ad> => {
    ...
    // FIX: Updated new ad object to use 'imageUrls' and added missing properties to match 'Ad' type.
    const newAd: Ad = {
        ...
        price: data.price,
        seller: currentUser,
        imageUrls: [URL.createObjectURL(data.image)], // Simulate image upload
        location: 'Unknown',
        rating: 0,
        reviews: 0,
        // FIX: Added missing 'condition' property to satisfy the 'Ad' type.
