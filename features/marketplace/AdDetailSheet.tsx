...
const StickyHeader: React.FC<{ ad: Ad; onContact: () => void; isOwnAd: boolean }> = ({ ad, onContact, isOwnAd }) => (
  <div className="sticky top-0 z-20 flex-shrink-0 bg-secondary/80 backdrop-blur-md border-b border-border-color flex items-center justify-between p-2">
    <div className="flex items-center min-w-0">
      <img src={ad.imageUrls[0]} alt={ad.title} className="w-10 h-10 rounded-md object-cover" />
...
const AdDetailSheet: React.FC = () => {
  ...
  const handleContactSeller = async () => {
    ...
    try {
        ...
        // Maybe navigate to chat view? For now, just a notification.
    } catch (err) {
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto">
              ...
              <div className="px-4">
                ...
                <Section title="About Seller">
                    <button className="w-full flex items-center justify-between p-3 bg-secondary rounded-lg hover:bg-border-color">
                ...
                <Section title="Feedback"><ReviewsPlaceholder /></Section>
