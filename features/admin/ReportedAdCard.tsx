    ...
    return (
        <div className="bg-primary border border-red-800/50 rounded-lg p-3">
            <div className="flex items-start space-x-3">
                {/* FIX: Replaced deprecated 'ad.imageUrl' with 'ad.imageUrls[0]' to match the updated 'Ad' type. */}
                <img src={ad.imageUrls[0]} alt={ad.title} className="w-16 h-16 object-cover rounded-md flex-shrink-0" />
